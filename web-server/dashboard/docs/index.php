    ...
    <div class="w3-row">
        ...
        <div class="w3-col s12 m8 l8">
            ...
            <ul class="breadcrumb w3-card-2 w3-container w3-margin-8">
                ...
                <li class="active">Documents</a></li>
            </ul>
            <br>

            <ul class="w3-navbar w3-theme-l2" style="margin: 10px 16px;">
                <li><a href="#" class="tablink w3-theme navBarTitle">Documents</a></li>
                <li class="w3-right w3-hover-theme"><a href="add.php" class="tablink w3-hover-theme">
                        Add New Document</a></li>
            </ul>
            ...
            <div class="w3-container">
                ...
                $docs = array_reverse($db->listDocsByUserId($userId));// = $db->listCourses("id");
                                    ...
                                    <div class='w3-row w3-small'>
                                        <div class='w3-col s11 m11 111'>
                                            <div class='w3-container'>
                                                ...
                                                <div class='w3-col s2 m2 l2 $statusColor w3-padding-8 w3-center' ><b>$status</b></div>
                                        ...
                                        <div class='w3-col s1 m1 11 w3-center'>
                                            <a href='../view/$id'><i class='fa fa-eye fa-2x'></i><br>
