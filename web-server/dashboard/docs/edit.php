   ...
   <div class="w3-row">
      ...
      <div class="w3-col s12 m8 l8">
         ...
         <div>
            ...
            } else if ($db->getDocData($_GET['id'], "submitBy") != $userId) {
            ...
            <div>
               ...
               method="post" action="actions.php?act=edit&id=<?php echo $id; ?>" enctype="multipart/form-data">
               ...
               <p>
                  ...
                  <select class="w3-select w3-border w3-round" name="docType" id="docType" required>
                     ...
                     print_r($docTypeArray);

                     for($i=0;$i<sizeof($docTypeArray);$i++){
                        $selected = ($docType == $docTypeArray[$i]['id'] ) ? "selected" : "";
                        if($i>2){
                           echo "<option value='$i' disabled $selected>".$docTypeArray[$i]['name']."</option>";
                        }else{
                           echo "<option value='$i' $selected>".$docTypeArray[$i]['name']."</option>";
                        }
                     }
                     ?>
                  </select>
